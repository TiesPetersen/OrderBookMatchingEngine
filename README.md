...
The benchmark is performed on synthetic order data. However, the synthetic order generator uses 5 different distribution for the random numbers generated, resulting in a very realistic simulation.

![Price movement generated by the syntethic order generator](./scripts/price_movement.png)
_Price movement generated by the syntethic order generator_
