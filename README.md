...
### Benchmark Data
The benchmark uses synthetic order data generated with 5 different distributions, creating a realistic market simulation. The grey line shows the generated base price, which serves as an anchor for limit orders placed at varying distances around it. Market and cancel orders are also synthetically generated and included in the dataset.
...
Prices are quantized to 2 decimal places, which causes limit orders to cluster at discrete price levels, creating realistic order book depth across the order book.
